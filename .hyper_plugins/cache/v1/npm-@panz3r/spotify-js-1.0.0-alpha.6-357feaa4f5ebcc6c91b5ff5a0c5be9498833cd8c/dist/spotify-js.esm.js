...
import { toLower, reduce, last, split, isArray, join } from 'lodash-es';
    ...
    try {
      ...
      return Promise.resolve(_this5._getInterfaces()).then(function (_ref3) {
        ...
        return Promise.resolve(properties.Get('org.mpris.MediaPlayer2.Player', 'Metadata')).then(function (metadata) {
          var trackMeta = reduce(metadata.value, function (dst, meta, k) {
            var key = last(split(k, ':'));
...
//# sourceMappingURL=spotify-js.esm.js.map
